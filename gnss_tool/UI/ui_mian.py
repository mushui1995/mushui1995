...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.connect_device = QPushButton(self.layoutWidget)
        ...
        self.widget = QWidget(self.gnss_view)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(280, 0, 511, 410))
        ...
        self.satellite_view = QGroupBox(self.widget)
        ...
        self.bias_view = QGroupBox(self.widget)
        self.bias_view.setObjectName(u"bias_view")
        sizePolicy2 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.bias_view.sizePolicy().hasHeightForWidth())
        self.bias_view.setSizePolicy(sizePolicy2)
        ...
        self.gnss_CN0 = QGroupBox(self.widget)
        self.gnss_CN0.setObjectName(u"gnss_CN0")
        sizePolicy3 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Fixed)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.gnss_CN0.sizePolicy().hasHeightForWidth())
        self.gnss_CN0.setSizePolicy(sizePolicy3)
